...
interface SavedEventDetailsModalProps {
  visible: boolean;
...
export default function SavedEventDetailsModal({
  visible,
  event,
  onClose,
  ...
  const imageSource = event.imageUrl ? { uri: event.imageUrl } : event.image;
                  ...
                  <View style={styles.backFaceContainer}>
                    ...
                    >
                      <View style={styles.eventContent}>
                        ...
                        {(event.impactStatement || event.aiOverview) && (
                        ...
                        {event.qaPairs && event.qaPairs.length > 0 && (
                          <View style={styles.qaSection}>
                            {event.qaPairs.map((qa, index) => (
